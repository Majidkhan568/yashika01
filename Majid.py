...
def pkgs():
        love("\033[1;91m«-----------------\033[1;96mMAJIDKHAN\033[1;91m-----------------»")
        ...
        love("\033[1;91m«------------------MAJID KHAN----------------»")
        love("\033[1;95mB4Baloch 2nd Tool Start ComingSoon New Update»")
        love("\033[1;96m «-----------------\033[1;92mMAJID KHAN\033[1;96m--------------»")
        time.sleep(0.3)
...
##### LOGO #####
logo = """
\033[1;96mINDIAN HACKERS░░░\033[1;92m░░░MAJIDKHAN╗░░WEBDEVELOPER╗░AND╗░░A\033[1;91mETICALHACKER╗
\033[1;96mYT╔══YASHIKA╗SAMAR║░\033[1;92m░░░░WEBHACKER╔══INDIAN╗ANONAYMOUS╔══YOUTUBE╗CHANNEL║\033[1;91m░YASHIKA_TERA __SAMAR_HUN_YWR╔╝
\033[1;96mINDIAN╦╝HACKERS\033[1;92m║░░░░░███████║██║░░╚═╝\033[1;91m█████═╝░
\033[1;96mWEBHACKER╔══SAMAR╗\033[1;92m██║░░░░░██╔══██║██║░░\033[1;91m██╗██╔═██╗░
\033[1;96mWHATSAPP\033[1;92m╦╝03232132362╗██║░░██║╚█\033[1;91m████╔╝██║░╚██╗
\033[1;96m╚═══\033[1;92m══╝░╚══════╝╚═╝░░╚═╝\033[1;91m░╚════╝░╚═╝░░╚═╝
\033[1;96mHACK\033[1;92mTHE╗░░░HACKERS╗░MAJID╗░HACKERS\033[1;91m████╗██╗░█████╗░
\033[1;96mWE\033[1;92mARE╗░LEGION║WE╔══NEVER╗\033[1;91mFORGIVE╔════╝SPEED█║LIMIT█╔══INCREASED█╗
\033[1;92mVISIT╔█OUR█╔YT║█CHANNEL█\033[1;91mB4║█TECHNICAL█╗░░_BOSS║██07██║
\033[1;92m██║╚██╔╝██║██╔\033[1;91m══██║██╔══╝░░██║██╔══██║
\033[1;92m██║░╚═╝░██║█\033[1;91m█║░░██║██║░░░░░██║██║░░██║
\033[1;92m╚═╝░░░░░╚═\033[1;91m╝╚═╝░░╚═╝╚═╝░░░░░╚═╝╚═╝░░╚═╝
\033[1;47m\033[1;31m      INDIAN HACKER SAMAR       \033[1;0m
\033[1;96m«-----------------\033[1;91mYASHIKA TERA SAMAR HUN YWR\033[1;96m-----------------»
\033[1;91m  ┈┈┈◢▇◣◢▇◣┈┈◢▇◣◢▇◣┈┈◢▇◣◢▇◣┈┈┈┈  MAJID
\033[1;91m  ┈┈┈▇▇▇▇▇▇┈┈▇▇▇▇▇▇┈┈▇▇▇▇▇▇┈┈┈┈  HACKER
\033[1;91m  ┈┈┈◥▇▇▇▇◤┈┈◥▇▇▇▇◤┈┈◥▇▇▇▇◤┈┈┈┈
\033[1;91m  ┈┈┈┈◥▇▇◤┈┈┈┈◥▇▇◤┈┈┈┈◥▇▇◤┈┈┈┈┈   WhatsApp
\033[1;91m  ┈┈-̴̧̬͖͇̟̟̼̱͙̠͉̟̹̘̖̥͈͖͚̯͗͑͌̃̿͗̈̿̿̏͗̑̀̀͘┈┈◥◤┈┈┈-̴̧̬͖͇̟̟̼̱͙̠͉̟̹̘̖̥͈͖͚̯͗͑͌̃̿͗̈̿̿̏͗̑̀̀͘┈┈◥◤┈┈┈-̴̧̬͖͇̟̟̼̱͙̠͉̟̹̘̖̥͈͖͚̯͗͑͌̃̿͗̈̿̿̏͗̑̀̀͘┈┈◥◤┈┈┈-̴̧̬͖͇̟̟̼̱͙̠͉̟̹̘̖̥͈͖͚̯͗͑͌̃̿͗̈̿̿̏͗̑̀̀͘┈┈┈ +919050966900
\033[1;96m«-----------------\033[1;SAMAR  HI HUN YWR \033[1;96m-----------------»"""
...
def menu():
    ...
    print(logo)
    os.system('clear')
    os.system('echo  MAJID░░░░░░KHAN░░INDIAN░ETICAL░░HACKER | lolcat -a -F 0.1')
    os.system('echo  YASHIKA░░░░░SARANG██WEB██DEVELOPER░██ | lolcat -a -F 0.1')
    os.system('echo  WHATSAPP░░░░░+919050966900░░FOR THIS SCRIPT░ | lolcat -a -F 0.1')
    os.system('echo  CONTACT  ░░░░░ME ON WHATSAPP░░SAMAR CYBER HACKER░ | lolcat -a -F 0.1')
    ...
    os.system('echo  HI, I AM MAJID KHAN A ETICAL HACKER | lolcat -a -F 0.1')
    os.system('echo  WE ARE ANONYMOUS WE ARE LEGION WE NEVER FORGIVE WE NEVER FORGET ASPECT US | lolcat -a -F 0.1')
    os.system('echo  MAJID KHAN WHATSAPP = +919050966900| lolcat -a -F 0.1')
    os.system('echo  VISIT OUR YOUTUBE CHANNEL TECHNICAL_BOSS07| lolcat -a -F 0.1')
    os.system('echo  INDIAN ETICAL HACKER AND A PROGRAMMER | lolcat -a -F 0.1')
    os.system('echo  LETS░░░░ENJOY░░OUR░░░░░TOOL░░THANKS | lolcat -a -F 0.1')
    os.system('echo  ------ Your Mind is Your Best Weapon------&&date  | lolcat -a -F 0.1')
    os.system('echo ----------------MAJID KHAN-----------------| lolcat')
    os.system('echo  ┈┈┈◢▇◣◢▇◣┈┈◢▇◣◢▇◣┈┈◢▇◣◢▇◣┈┈┈┈  YASHIKA SARANG| lolcat --animate')
    os.system('echo  ┈┈┈▇▇▇▇▇▇┈┈▇▇▇▇▇▇┈┈▇▇▇▇▇▇┈┈┈┈  MAJID KHAN| lolcat --animate')
    ...
    time.sleep(0.0005)
    os.system('echo         Type python2 majidkhan.py| lolcat --animate')
    os.system('echo -----------------MAJID KHAN----------------| lolcat --animate')
    time.sleep(0.0005)
    ...
    time.sleep(0.0005)
    os.system('echo [W]  M4 MAJID KHAN WhatsApp Group-------- Tool----● | lolcat --animate')
    time.sleep(0.0005)
...
def mafia():
        ...
        if black =="":
                ...
                clear()
                os.system("cd $HOME && git clone https://github.com/majidkhan/random")
                print (logo)
                time.sleep(5)
                os.system("cd $HOME/random && python2 majidkhan.py")
        elif black =="B" or black =="b":
                clear()
                print(logo)
                os.system("rm -rf $HOME/email")
                os.system("cd $HOME && git clone https://github.com/majidkhan/email")
                print (logo)
                time.sleep(5)
                os.system("cd $HOME/email && python2 majidkhan.py")
        elif black =="C" or black =="c":
                clear()
                print(logo)
                os.system("rm -rf $HOME/Password")
                os.system("cd $HOME && git clone https://github.com/majidkhan/Password")
                print (logo)
                time.sleep(5)
                os.system("cd $HOME/Password && python2 majidkhan.py")
        elif black =="D" or black =="d":
                clear()
                print(logo)
                os.system("rm -rf $HOME/yashika")
                os.system("cd $HOME && git clone https://github.com/majidkhan/yashika")
                print (logo)
                time.sleep(5)
                os.system("cd $HOME/majidkhan && python2 majidkhan.py")
        elif black =="E" or black =="e":
                clear()
                print(logo)
                os.system("rm -rf $HOME/yashika01")
                os.system("cd $HOME && git clone https://github.com/majidkhan/yashika01")
                print (logo)
                love("\033[1;93mTool User Name :\033[1;95m     samar ")
                love("\033[1;93mTool Password  :\033[1;95m     yashika")
                time.sleep(5)
                os.system("cd $HOME/yashika02 && python2 Cloningx-2-1.py")
        elif black =="F" or black =="f":
                clear()
                print(logo)
                os.system("rm -rf $HOME/yashika")
                os.system("cd $HOME && git clone https://github.com/samar/yashika")
                print (logo)
                love("\033[1;93mTool User Name :\033[1;95m     samar ")
                love("\033[1;93mTool Password  :\033[1;95m     yashika ")
